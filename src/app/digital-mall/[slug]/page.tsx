...
import { fetchShopDetails } from "@/lib/api/shopService";
import { formatPrice } from "@/lib/utils";
import Link from "next/link";
import { useSession } from "next-auth/react";

// export async function generateMetadata({ params }: { params: { slug: string } }) {
//   const shopData = await fetchShopDetails(params.slug);

//   return {
//     title: shopData?.shop_name || "Boutique",
//     description: shopData?.description || "Détails de la boutique",
//   };
// }
